...
class SettingsStore {
    ...
    var hotloadMethod: String
        get() = HotloadSupport.methodFromConfig(AppSettings.getString("hotloadMethod", "SHELL"))
        set(value) = AppSettings.setString("hotloadMethod", HotloadSupport.methodFromConfig(value))
